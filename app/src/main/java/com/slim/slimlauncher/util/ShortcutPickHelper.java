// This file derived from: https://github.com/SlimRoms/packages_apps_SlimLauncher
// The license for this work appears to be Apache 2.0, per notice in the root of that project
...
import com.js.applauncherdemo.R;
...
//        shortcutIcons.add(Intent.ShortcutIconResource.fromContext(mParent, R.drawable.activities_icon));
        // TODO replace the following temporary icon
        shortcutIcons.add(Intent.ShortcutIconResource.fromContext(mParent, R.drawable.ic_launcher));
...
//            groupPadding = context.getResources().getDimensionPixelSize(R.dimen.shortcut_picker_left_padding);
            // TODO replace following temporary padding
            groupPadding = context.getResources().getDimensionPixelSize(R.dimen.abc_action_bar_default_padding_material);
        }
